                  ...
                  Padding(
                    ...
                    child: IconButton(
                      icon: Icon(
                        ...
                        //TODO ir a pagina chat pero con el bottom menu
                      ),
                      onPressed: () {
                        Navigator.push(
                            context,
  ...
  Widget ofertas2(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => testChatInt()));
        },
        child: Padding(
              ...
              Row(
                children: [
                  CircleAvatar(
                    ...
                    child: ClipOval(
                      child: Image.network(
                        'https://upload.wikimedia.org/wikipedia/commons/c/cf/Payaso_Cucharita.jpg',
                        fit: BoxFit.cover,
                        width: 100,
                        height: 100,
                      ),
